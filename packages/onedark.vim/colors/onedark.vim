...
call s:h('htmlAttribute', { 'fg': s:dark_yellow })
call s:h('htmlEscape', { 'fg': s:dark_yellow })
call s:h('htmlHeaderText', { 'fg': s:yellow, 'gui': 'bold', 'cterm': 'bold' })
call s:h('htmlBoldText', { 'fg': s:purple, 'gui': 'bold', 'cterm': 'bold' })
call s:h('htmlEmphasisText', { 'fg': s:purple, 'gui': 'italic', 'cterm': 'italic' })
